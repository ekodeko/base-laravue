...
const meta = props.accounts.meta
...
const filteredData = computed(() => {
  ...
  return props.accounts.data.filter(row =>
...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
      <div>
        <Link href="/master/accounts/create">
        <Button>
          + Add Account
        </Button>
        </Link>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem as-child>
                          <Link :href="'/master/accounts/'+acc.id+'/edit'">Edit</Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem as-child>
                          <Link method="delete" as="button" class="w-full text-red-600">
                          Delete
                          </Link>
                        </DropdownMenuItem>
                      </DropdownMenuContent>
